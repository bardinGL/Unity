...
public class ScriptCase3 : MonoBehaviour
{
    ...
    private void UpdatePhysicsData()
    {
        ...
        velocityText.text = $"Velocity for case 3: {currentVelocity.magnitude:F2} m/s";
        accelerationText.text = $"Acceleration for case 3: {acceleration.magnitude:F2} m/s²";
